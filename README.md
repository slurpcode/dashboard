...
I am using [Cloc](https://github.com/AlDanial/cloc) to display statistics on the homepage and since this project has been developed on primarily on Windows you will need to add it to your Windows path.
